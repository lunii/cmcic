...
CMCIC.tpe.prototype.init = function (config) {
  this._tpe = {
    ...
    CMCIC_LNG: 'FR',
    CMCIC_CURRENCY: 'EUR',
    CMCIC_SERVEUR: 'https://p.monetico-services.com',
    CMCIC_URLOK: "",
    CMCIC_URLKO: "",
    test: false
  };
...
CMCIC.transaction.prototype.init = function (transactionData) {
  this._data = {
    ...
    reference: '',
    texteLibre: {},
    contexte_commande: {}, // TODO: encode to base 64 ! utf8
    email: '',
    NbrEch: '',
    DateEcheance1: '',
    MontantEcheance1: '',
...
CMCIC.transaction.prototype.dataToSend = function (data) {
  ...
  return this._tpe._tpe.CMCIC_TPE +
    ...
    // '*' + data.options; // FIXME: remove options and add
    '*' + data.aliascb +
    '*' + data.forcesaisiecb +
    '*' + data['3dsdebrayable'] +
    '*' + data.libelleMonetique +
    '*' + data.desactivemoyenpaiement;
};
